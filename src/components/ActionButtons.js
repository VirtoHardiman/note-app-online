...
import { MdOutlineMoreVert, MdClose, MdOutlineDelete, MdOutlineArchive, MdOutlineUnarchive } from "react-icons/md";
    ...
    <div className="note-actions">
      {showButtons ? (
        <>
          ...
          {note.archived ? (
            <button onClick={handleUnarchive} className="unarchive-button" disabled={isLoading}>
              <MdOutlineUnarchive className="unarchive-icon" alt="unarchive-icon" />
            </button>
          ) : (
            <button onClick={handleArchive} className="archive-button" disabled={isLoading}>
